...
(meditations
  ...
  (= "123 Test Lane, Testerville, TX"
     (let [{street-address :street-address,
            city :city, state :state} test-address]
       #_(str street-address ", " city ", " state)
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     ((fn [[n f] {:keys [street-address city state]}]
        (str n " " f ", " (clojure.string/join ", " [street-address city state])))
