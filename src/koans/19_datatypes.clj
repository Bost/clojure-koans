...
(defrecord Nobel [prize])  ;; new type derrived from a map type
(deftype Pulitzer [prize]) ;; new type derrived from a ??? type - keyword cannot
                           ;; be used

(defprotocol Award         ;; named set of named methods and their signatures
