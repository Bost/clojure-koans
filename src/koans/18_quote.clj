...
(meditations
  ...
  "You can use a literal list as a data collection without having Clojure try to
  call a function"
  (= (cons 1 (vec '(2 3))) ;; list instead of vec doesn't work
     (list 1 2 3)
     (cons 1 [2 3]))
  ...
  "Unquote (~) within a syntax-quoted expression lets you mark specific
  expressions as requiring evaluation"
  (= (list 1 5) `(1 ~(+ 2 3)) '(1 5)))
